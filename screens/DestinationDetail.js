...
//             <View style={{flex:2}}>
//               <Image source={images.skiVillaBanner} style={{width:'100%', height:'100%'}} resizeMode="cover"/>
//               <View style={{padding:SIZES.padding, position:"absolute",bottom:"5%", left:"5%", right:"5%", backgroundColor:COLORS.white, borderRadius:15, elevation:18}}>
//                 <View style={{flexDirection:"row"}}>
//                     <View style={{elevation:11}}>
//                         <Image source={images.skiVilla} style={{width:70, height:70, borderRadius:15}}/>
//                     </View>
